...
import 'package:mobile_app1/UI/home/theme_demo/theme6.dart';
import 'package:mobile_app1/UI/home/theme_demo/theme7.dart';
...
void main() {
  runApp(
    MaterialApp(
      ...
      initialRoute: '/theme6',
      routes: {
        '/theme6': (context) => const Theme6(),
        '/theme7': (context) => const Theme7(),
      },
    ),
  );
}
